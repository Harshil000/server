...
3. **Configure the OAuth Consent Screen:**
   - Open the **OAuth consent screen** section in the Google Cloud Console.
   - Choose the user type that fits your app, usually **External** for testing.
   - Fill in the app name, support email, and developer contact information.
   - Add the Gmail scope you need, such as `https://mail.google.com/`.
   - Add your **demo user** or **test user** email address in the **Test users** section so that Google allows that account to authorize the app while it is in testing mode.
...
2. **Configure OAuth 2.0 Playground:**
   ...
   - Make sure the Google account you use here is added as a **test/demo user** in the OAuth consent screen if your app is still in testing.
